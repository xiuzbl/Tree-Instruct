...
def generate_dataset(model_type, model_path, in_files, out_prefix, gpt3_weight, seed, eval_ratio, out_dir):
    # Load conversations
    conversations = []
    for filename in in_files:
        ...
        with open(filename, "r") as f:
            ...
            conversations = [json.loads(i) for i in f.readlines()]
